...
return [
    ...
    | versions, comme les règles de taille. N'hésitez pas à modifier chacun de ces messages ici.
    |
    */
    ...
    | en utilisant la convention "attribute.rule" pour nommer les lignes. Cela vous permet
    | de spécifier rapidement une ligne de langue personnalisée pour une règle d'attribut donnée.
    |
    */
